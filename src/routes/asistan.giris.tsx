...
import { assistantLogin } from "@/lib/actions";

export const Route = createFileRoute("/asistan/giris")({ component: AssistantLogin });
    ...
    <div className="flex min-h-dvh items-center justify-center bg-sand px-4">
      <form
        ...
        onSubmit={async (e) => {
          ...
          setPending(true);
          try {
            const res = await assistantLogin({
              data: {
      ...
      >
        ...
        <h1 className="mt-6 text-center text-3xl">Asistan girişi</h1>
        <p className="mt-1 text-center text-sm text-muted">Klinik asistan paneli</p>
