...
export function WhatsAppBubble({
  ...
  const href = whatsappLink(
    CLINIC.phoneRaw,
    message ?? `Merhaba, Dyt. ${CLINIC.name} ile görüşmek istiyorum.`,
  );
  ...
  return createPortal(
    <a
      ...
      className={cn(
        "grid size-16 place-items-center rounded-full bg-[#25D366] text-white",
        "shadow-[0_10px_28px_rgba(37,115,54,0.45)]",
        "hover:scale-105 hover:bg-[#1ebe57]",
      )}
    >
